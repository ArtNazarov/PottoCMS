...
class Halgerda
{
	...
	function __construct(&$params)
	{
		...
		$gears = @array(
			 'pageitem' => 'SitePageItem', // Страница
			 'categoryitem' => 'SiteCategoryItem', // Категория
			 'view' => 'Lorius', // Шаблонизатор
			 'options' => 'WiseMonkey', // Опции сайта
			 'comments' => 'Vombat', // Комментарии
			 'usr' => 'Meerkat', // Пользователи
	         'formitems' => 'FormItems', // Формы
			 'blocks' => 'Entropia', // Глобальные блоки
                         'styles' => 'Styles' // Таблицы стилей!
			);
